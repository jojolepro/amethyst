...
pub fn load_material(
    ...
    info!("NAME: {}, TEXTURE base_color_texture.is_some(): {} BASE_COLOR_FACTOR: {:?}", name, material.pbr_metallic_roughness().base_color_texture().is_some(), material.pbr_metallic_roughness().base_color_factor());
    prefab.albedo = Some(
