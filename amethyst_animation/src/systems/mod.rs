...
pub use self::{control::AnimationControlSystem, sampling::build_sampler_interpolation_system};
...
pub fn build_sampler_processor<S>(
    world: &mut World,
...
pub fn build_animation_processor<S>(
    world: &mut World,
    resources: &mut Resources,
) -> Box<dyn Schedulable> {
